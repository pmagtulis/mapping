...
map.on("load", function () {
    map.addLayer({
      ...
      source: {
        type: "geojson",
        data: "https://raw.githubusercontent.com/pmagtulis/mapping/main/US-polls/data/statesElections.geojson",
      },
      paint: {
        "line-color": "#ffffff",
        "line-width": 0.7,
    ...
    map.addLayer(
        {
          ...
          source: {
            type: "geojson",
            data: "https://raw.githubusercontent.com/pmagtulis/mapping/main/US-polls/data/countiesElections.geojson",
          },
          minzoom: 6,
          paint: {
            "line-color": "#ffffff",
